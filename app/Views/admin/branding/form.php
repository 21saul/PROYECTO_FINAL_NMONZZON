...
/*
 * =============================================================================
 * VISTA CI4: APP/VIEWS/ADMIN/BRANDING/FORM.PHP
 * =============================================================================
...
$pageTitle = $isEdit ? 'Editar proyecto de branding' : 'Nuevo proyecto de branding';
$this->setVar('pageTitle', $pageTitle);
$formAction = $isEdit ? base_url('admin/branding/' . (int) $project['id']) : base_url('admin/branding');
?>
...
<div class="admin-page-header">
    ...
    <a href="<?= base_url('admin/branding') ?>" class="btn btn-admin-outline">
        ...
        <form action="<?= esc($formAction) ?>" method="post" enctype="multipart/form-data" class="admin-form" novalidate>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="client_name" id="client_name" class="form-control" maxlength="200"
                           value="<?= esc(old('client_name', is_array($project) ? ($project['client_name'] ?? '') : '')) ?>">
                </div>
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?= base_url('admin/branding') ?>" class="btn btn-outline-secondary">Cancelar</a>
            </div>
        </form>
    </div>
</div>
