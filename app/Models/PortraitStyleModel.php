...
/*
 * =============================================================================
 * PORTRAITSTYLEMODEL — MODELO CODEIGNITER 4 (CAPA DE DATOS)
 * =============================================================================
 * TABLA PRINCIPAL: PORTRAIT_STYLES.
...
class PortraitStyleModel extends Model
{
    protected $table            = 'portrait_styles';
    ...
    protected $validationRules = [
        ...
        'slug'       => 'required|is_unique[portrait_styles.slug,id,{id}]',
