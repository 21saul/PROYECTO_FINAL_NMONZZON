...
// DECLARA UNA CLASE
class CreateBrandingProjectsTable extends Migration
// DELIMITADOR DE BLOQUE
{
    ...
    // DELIMITADOR DE BLOQUE
    {
        ...
        $this->forge->addField([
            ...
            // ASIGNACIÓN O OPERACIÓN CON ASIGNACIÓN
            'client_name'   => ['type' => 'VARCHAR', 'constraint' => 100, 'null' => true],
            // ASIGNACIÓN O OPERACIÓN CON ASIGNACIÓN
            'description'   => ['type' => 'TEXT', 'null' => true],
            // ASIGNACIÓN O OPERACIÓN CON ASIGNACIÓN
            'services_provided' => ['type' => 'JSON', 'null' => true],
            // ASIGNACIÓN O OPERACIÓN CON ASIGNACIÓN
        ...
        // LLAMADA O INSTRUCCIÓN TERMINADA EN PUNTO Y COMA
        $this->forge->createTable('branding_projects');
    // DELIMITADOR DE BLOQUE
    }
    ...
    {
        // LLAMADA O INSTRUCCIÓN TERMINADA EN PUNTO Y COMA
        $this->forge->dropTable('branding_projects');
    // DELIMITADOR DE BLOQUE
    }
// DELIMITADOR DE BLOQUE
}
